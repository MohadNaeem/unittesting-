...
public class RulesOf6005 {
	...
	public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
        ...
        if (availableToOthers && citingYourSource) {
            return true; // You can use publicly available code if you cite it.
        }
        
        if (writtenAsCourseWork && implementationRequired) {
            return true; // You can use code written as course work if it's required.
        }
        
        return false; // In all other cases, you cannot use the code.
    }
